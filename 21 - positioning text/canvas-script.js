...
window.onload = function () {
    // Definitions
    var canvas  = document.getElementById("positioning-text-canvas");
    var context = canvas.getContext("2d");

    // context.textAlign = "center | end | left | right | start";
    // Specifies how text is align horizontally
    ...
    context.fillText("right", 300, 130);
